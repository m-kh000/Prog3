...
public class FilterTasks extends FunctionPanel {
    public FilterTasks(JPanel centerPanel, JFrame frame, core.Factory factory) {
        setLayout(new BorderLayout());
        add(createTopPanel("Filter Tasks", centerPanel, frame, factory, "supervisor"), BorderLayout.NORTH);
